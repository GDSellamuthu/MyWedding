  ...
  <body>
	...
	<nav class="navbarheader navbar navbar-inverse navbar-static-top" role="navigation">
	  ...
	  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-Booktique-navbar-collapse-1">
	   ...
	   <div class="collapse navbar-collapse navbar-right" id="bs-wedding-navbar-collapse-1">
	  ...
	  <div class="row">
			  <div class="col-sm-6 col-md-12">
	           ...
	           <div class=" formimage container">
						...
						<h2>About Us</h2>
					    <h3>The Wedding Experts started in early 2015 by Mr.George.This website allow customers<br /> to do their
						dream wedding based on their ideas, interest and budget. Our customer fully<br />satisfied with our service
						and have given good feedback. Users allow to do free registration<br />to our website to access our services.
						You can contact our "experts". Our experts are well<br /> known in wedding planning events and also qualified. Users can
						contact them by sending<br />them messages about your dream wedding ideas. You can also perform
						a quick calculation<br /> of your estimated budget for each events on your wedding day using our quick calculator.
						</h3>
