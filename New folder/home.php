	...
	<nav class="navbarheader navbar navbar-inverse navbar-static-top" role="navigation">
	  ...
	  <div class="row">
				...
				<div class="accountarea thumbnail">
					...
					time amount in your schedule and we can help you overcome these issues.You can send me your<br /> wedding details
					and the things needed on your special day.When all is set and done, final scehulde decisions are up to<br /> you
					and we will work on whatever framework your provide with the best outcome.In order to provide the best outcome<br />
					on your wedding day, we recommended to involve us earlier so we can provide you with important information
					related<br />to how certain choices might affect your wedding day.</p>
		  ...
		  <div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
			  ...
			  <div><input type="checkbox" class="read-more-state" id="post-1" />
				...
				<p class="read-more-wrap">If you are a flower lover, you can add more flowers to your wedding and also as a door gift
				<span class="read-more-target">Our Flowers in vintage soda bottles will excite you and also your guest, recycling old
			  ...
			  <div class="row">
			  <div class="col-sm-6 col-md-12">
				<div class="detailfooter thumbnail">
				</div>
<!--footer-->
<div class="thumnail">
 ...
 <ul class="social-icon animate pull-right">
                   <li>   <a href="#"><small style="color:grey" class="fa fa-lg fa-facebook pull-right"></a></li>
