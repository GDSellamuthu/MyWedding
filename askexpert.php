...
<html lang="en">
  ...
  <head>
    ...
    <link href="css/askexpertsstyle.css" rel="stylesheet">
	  ...
	  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-Booktique-navbar-collapse-1">
	   ...
	   <div class="collapse navbar-collapse navbar-right" id="bs-Booktique-navbar-collapse-1">
	    <ul class="nav navbar-nav  ">
		   ...
		   <li><a href="http://localhost/wed/aboutpage.php">Contacts</a></li>
		</ul>
	  </div>
	  </div>
	  </nav>
	  ...
	  <div class="row">
			  <div class="col-sm-6 col-md-12">
	           ...
	           <div class=" formimage container">
						...
						<h2>Ask Experts!</h2>
					    <h3>Tell us about about your dream wedding and get feedback from our experts.</h3>
						
					<form action="handle_askexpert.php" method="post">
					<div class="row">
			        <div class="col-sm-6 col-md-10">
				    <div class="ask thumbnail">
					<fieldset><legend>My Dream Wedding</legend>
